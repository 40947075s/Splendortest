...
public class TakeTokenController : MonoBehaviourPunCallbacks
{
    ...
    private bool IsBtnAllow(){
        return GameSceneManager.Instance.myGM.IsTokensAllowToTake(tokenNum);
    }
    
    public void ClearTakeToken(){
    ...
    public void OnClickSubmit(){
        GameSceneManager.Instance.ActTakeToken(tokenNum);
        ClearTakeToken();
    }

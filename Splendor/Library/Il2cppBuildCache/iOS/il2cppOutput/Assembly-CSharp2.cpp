...
IL_090a:
	{
		...
		NullCheck(L_386);
		VirtualActionInvoker2< Mesh_t2F5992DBA650D5862B43D3823ACD997132A57DA6 *, int32_t >::Invoke(107 /* System.Void TMPro.TMP_Text::UpdateGeometry(UnityEngine.Mesh,System.Int32) */, L_386, L_390, L_391);
		// for (int i = 0; i < textInfo.meshInfo.Length; i++)
...
IL_0172:
	{
		...
		NullCheck(L_98);
		List_1_Add_m226DC7C5142E31004C697DF7D8E1B6C44794A83F(L_98, L_99, /*hidden argument*/List_1_Add_m226DC7C5142E31004C697DF7D8E1B6C44794A83F_RuntimeMethod_var);
		...
		NullCheck(L_100);
		List_1_Add_m415CDDDC44D8102E7E71D9EA0A853D7BBE6F469F(L_100, ((int32_t)il2cpp_codegen_subtract((int32_t)L_103, (int32_t)1)), /*hidden argument*/List_1_Add_m415CDDDC44D8102E7E71D9EA0A853D7BBE6F469F_RuntimeMethod_var);
...
IL_073d:
	{
		NullCheck(G_B21_1);
		List_1_Sort_m73052155A560BC25060019E8D60C596E426871FB(G_B21_1, G_B21_0, /*hidden argument*/List_1_Sort_m73052155A560BC25060019E8D60C596E426871FB_RuntimeMethod_var);
		...
		NullCheck(L_274);
		VirtualActionInvoker2< Mesh_t2F5992DBA650D5862B43D3823ACD997132A57DA6 *, int32_t >::Invoke(107 /* System.Void TMPro.TMP_Text::UpdateGeometry(UnityEngine.Mesh,System.Int32) */, L_274, L_278, L_279);
		// for (int i = 0; i < textInfo.meshInfo.Length; i++)
